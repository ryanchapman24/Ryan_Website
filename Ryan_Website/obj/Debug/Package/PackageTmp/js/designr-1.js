$(document).ready(function() {
	...
	$('.project-item').click(function(e){
		...
		if (title === "JavaScript Exercises") {

		    $('#project-modal-JS').on('show.bs.modal', function () {
		        ...
		        setTimeout(function () {
		            $('.image-wrapper.flexslider').flexslider({
		                ...
		                controlNav: false,
		                start: function () {
		                    $('#project-modal-JS .image-wrapper')
						    .addClass('done')
						    .prev('.loader').fadeOut();
		                }
		            });
		    ...
		    $('#project-modal-BLOG').on('show.bs.modal', function () {
		        $(this).find('h1').text(title);
		        $(this).find('.btn').attr('href', link);
		        $(this).find('.project-descr').html(descr);
		        $(this).find('.image-wrapper').addClass('flexslider').html(slidesHtml);
		        ...
		        setTimeout(function () {
		            $('.image-wrapper.flexslider').flexslider({
		                ...
		                controlNav: false,
		                start: function () {
		                    $('#project-modal-BLOG .image-wrapper')
						    .addClass('done')
						    .prev('.loader').fadeOut();
		                }
		            });
		...
		else if (title === "Bug Tracker") {
		    $('#project-modal-BT').on('show.bs.modal', function () {
		        $(this).find('h1').text(title);
		        $(this).find('.btn').attr('href', link);
		        $(this).find('.project-descr').html(descr);
		        $(this).find('.image-wrapper').addClass('flexslider').html(slidesHtml);
		        ...
		        setTimeout(function () {
		            $('.image-wrapper.flexslider').flexslider({
		                ...
		                controlNav: false,
		                start: function () {
		                    $('#project-modal-BT .image-wrapper')
						    .addClass('done')
						    .prev('.loader').fadeOut();
		                }
		            });
		...
		else if (title === "Budgeting System") {
		    $('#project-modal-BS').on('show.bs.modal', function () {
		        $(this).find('h1').text(title);
		        $(this).find('.btn').attr('href', link);
		        $(this).find('.project-descr').html(descr);
		        $(this).find('.image-wrapper').addClass('flexslider').html(slidesHtml);
		        ...
		        setTimeout(function () {
		            $('.image-wrapper.flexslider').flexslider({
		                ...
		                controlNav: false,
		                start: function () {
		                    $('#project-modal-BS .image-wrapper')
						    .addClass('done')
						    .prev('.loader').fadeOut();
		                }
		            });
		...
		else if (title === "Online Retailer") {
		    $('#project-modal-CL').on('show.bs.modal', function () {
		        $(this).find('h1').text(title);
		        $(this).find('.btn').attr('href', link);
		        $(this).find('.project-descr').html(descr);
		        $(this).find('.image-wrapper').addClass('flexslider').html(slidesHtml);
		        ...
		        setTimeout(function () {
		            $('.image-wrapper.flexslider').flexslider({
		                ...
		                controlNav: false,
		                start: function () {
		                    $('#project-modal-CL .image-wrapper')
						    .addClass('done')
						    .prev('.loader').fadeOut();
		                }
		            });
		...
		else if (title === "Digital Art") {
		    $('#project-modal-DA').on('show.bs.modal', function () {
		        $(this).find('h1').text(title);
		        $(this).find('.btn').attr('href', link);
		        $(this).find('.project-descr').html(descr);
		        $(this).find('.image-wrapper').addClass('flexslider').html(slidesHtml);
		        ...
		        setTimeout(function () {
		            $('.image-wrapper.flexslider').flexslider({
		                ...
		                controlNav: false,
		                start: function () {
		                    $('#project-modal-DA .image-wrapper')
						    .addClass('done')
						    .prev('.loader').fadeOut();
		                }
		            });
	...
	$('.projects').on('hidden.bs.modal', function () {
	...
	Backstretch Images
	==============================================*/
	$.backstretch('assets/Waterfall.jpg');

	$('body').append('<img class="preload-image" src="assets/Mountains_Stars.jpg" style="display:none;"/>');
	...
	$('#about').waypoint(function(direction){
		...
		if (direction=='down'){
			$.backstretch('assets/Mountains_stars.jpg');
		}else{
			$.backstretch('assets/Waterfall.jpg');
		}
	});
